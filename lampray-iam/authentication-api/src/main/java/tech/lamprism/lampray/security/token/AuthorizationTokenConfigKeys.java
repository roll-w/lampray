...
public class AuthorizationTokenConfigKeys implements SettingSpecificationSupplier {
    public static final AttributedSettingSpecification<String> TOKEN_ISSUER =
            new SettingSpecificationBuilder<>(ConfigKey.ofString("security.token.authorization.issuer"))
    ...
    public static final AttributedSettingSpecification<Long> ACCESS_TOKEN_EXPIRE_TIME =
            new SettingSpecificationBuilder<>(ConfigKey.ofLong("security.token.authorization.access.expire-time"))
    ...
    public static final AttributedSettingSpecification<Long> REFRESH_TOKEN_EXPIRE_TIME =
            new SettingSpecificationBuilder<>(ConfigKey.ofLong("security.token.authorization.refresh.expire-time"))
    ...
    public static final AttributedSettingSpecification<String> TOKEN_KEY_TYPE =
            new SettingSpecificationBuilder<>(ConfigKey.ofString("security.token.authorization.sign-key.type"))
    ...
    public static final AttributedSettingSpecification<String> TOKEN_SECRET_KEY =
            ...
            new SettingSpecificationBuilder<>(ConfigKey.ofString("security.token.authorization.sign-key.secret-key"))
    ...
    public static final AttributedSettingSpecification<String> TOKEN_KEY_ALGORITHM =
            new SettingSpecificationBuilder<>(ConfigKey.ofString("security.token.authorization.sign-key.algorithm"))

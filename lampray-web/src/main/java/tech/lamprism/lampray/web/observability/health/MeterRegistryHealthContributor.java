 ...
 */
@Component
public class MeterRegistryHealthContributor implements HealthContributor {
    private final MeterRegistry meterRegistry;

    public MeterRegistryHealthContributor(MeterRegistry meterRegistry) {
        this.meterRegistry = meterRegistry;
    }

    @Override
    public String getName() {
        return HealthContributorNames.METER_REGISTRY;
    }

...
include(":lampray-file:storage-service")
...
include(":lampray-observability")
include(":lampray-observability:observability-api")
include(":lampray-observability:observability-core")
...
project(":lampray-file:storage-service").projectDir = file("lampray-file/storage-service")
...
project(":lampray-observability:observability-api").projectDir = file("lampray-observability/observability-api")
project(":lampray-observability:observability-core").projectDir = file("lampray-observability/observability-core")

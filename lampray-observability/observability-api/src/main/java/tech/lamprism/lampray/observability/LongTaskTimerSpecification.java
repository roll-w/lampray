 ...
 * @author RollW
 */
public final class LongTaskTimerSpecification extends AbstractMetricSpecification<LongTaskTimer> {
    private LongTaskTimerSpecification(Builder builder) {
        super(builder.name, builder.tagSpecifications, builder.description, null, LongTaskTimer.class);
    }
    ...
    public static final class Builder {
        ...
        public LongTaskTimerSpecification build() {
            return new LongTaskTimerSpecification(this);
        }
    }
}

...
public interface StorageQueryProvider {
    ...
    StorageFileDetails getFile(String fileId);

    Page<StorageSessionView> listSessions(int page,
                                          int size,
                                          StorageUploadSessionState state,
                                          Long ownerUserId,
                                          String fileName);

    StorageSessionDetails getSession(String uploadId);

    List<StorageBackendView> listBackends();

    List<StorageGroupView> listGroups();
}

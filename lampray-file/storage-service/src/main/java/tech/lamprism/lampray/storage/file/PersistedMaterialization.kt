...
data class PersistedMaterialization(
    ...
    fun toMaterializationContext(groupName: String, ownerUserId: Long?): StorageMaterializationContext =
        StorageMaterializationContext(fileStorage, blobId, groupName, ownerUserId)
}

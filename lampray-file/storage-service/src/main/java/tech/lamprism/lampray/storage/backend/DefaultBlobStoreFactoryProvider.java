...
public class DefaultBlobStoreFactoryProvider implements BlobStoreFactoryProvider {
    private final Map<StorageBackendType, BlobStoreFactory> factoriesByType;

    public DefaultBlobStoreFactoryProvider(List<BlobStoreFactory> blobStoreFactories) {

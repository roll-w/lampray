...
/**
 * Registry-backed blob-store locator.
 *
 * @author RollW
 */
@Component
public class RegistryBlobStoreLocator implements BlobStoreLocator {
    private final BlobStoreRegistry blobStoreRegistry;

    public RegistryBlobStoreLocator(BlobStoreRegistry blobStoreRegistry) {

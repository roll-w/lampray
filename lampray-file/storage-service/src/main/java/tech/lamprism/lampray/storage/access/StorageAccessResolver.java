...
/**
 * Internal resolver contract used by composite storage access resolution.
 * <p>
 * Returning {@code null} means the resolver does not own the requested id.
 *
 * @author RollW
 */
public interface StorageAccessResolver {

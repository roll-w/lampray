...
/**
 * Centralizes validation and normalization rules for storage uploads.
 *
 * @author RollW
 */
@Component
public class StorageUploadValidationSupport implements StorageUploadValidator {
    ...
    public void validateUploadRequest(StorageUploadRequest request,
        ...
        if (requestedSize != null) {
            validateGroupSizeLimit(groupSettings.getMaxSizeBytes(), requestedSize);
        }
    ...
    public void validateUploadedContent(StorageUploadSessionEntity uploadSession,
                                        ...
                                        StorageGroupConfig groupSettings) {
        validateGroupSizeLimit(groupSettings.getMaxSizeBytes(), tempUpload.size());
        validateDeclaredSize(uploadSession.getFileSize(), tempUpload.size());
    ...
    public void validateUploadedObject(StorageUploadSessionEntity uploadSession,
                                       ...
                                       StorageGroupConfig groupSettings) {
        validateGroupSizeLimit(groupSettings.getMaxSizeBytes(), uploadedObject.size());

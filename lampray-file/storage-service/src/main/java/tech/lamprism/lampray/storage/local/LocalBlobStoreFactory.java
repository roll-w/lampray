...
package tech.lamprism.lampray.storage.local;
 ...
 */
@Component
public class LocalBlobStoreFactory implements BlobStoreFactory {
    @Override
    ...
    @Override
    public BlobStore create(StorageBackendConfig config) throws IOException {
        return new LocalBlobStore(
                config.getName(),
                Path.of(Objects.requireNonNull(config.getRootPath())),
